    # -*- coding: utf-8 -*-
"""
    Created on Sat Mar 23 19:18:17 2019
...
def hel_test(ip1, ip2, ip3, ip4, ip5, ip6, ip7, ip8, ip9):
    import cv2 as cv
    import numpy as np
    import os.path
    ...
    global frame_count
    global frame_count_out       #change to global variable      # used in mainloop  where we're extracting images., and then to drawPred( called by post process)
    ...
    classesFile = "C:\\Users\\prajwal mj\\.spyder-py3\\Project\\Helmet_det\\obj.names";
    classes = None
    with open(classesFile, 'rt') as f:
        classes = f.read().rstrip('\n').split('\n')
    
    # Give the configuration and weight files for the model and load the network using them.
    modelConfiguration = "C:\\Users\\prajwal mj\\.spyder-py3\\Project\\Helmet_det\\yolov3-obj.cfg";
    modelWeights = "C:\\Users\\prajwal mj\\.spyder-py3\\Project\\Helmet_det\\yolov3-obj_2400.weights";
    ...
    # Draw a bounding box.
        ...
        print('IN DRAW PRED: ',frame_count)
        if(frame_count> 0):
            return frame_count
    ...
    def postprocess(frame, outs):
        ...
        if count_person >= 1:
            ...
            #print(type(frame))
            cv.imshow('img',frame) #check here, while automating, getting error here only, I think
            cv.waitKey(800)
    ...
    #img1 = cv.imread("C:\\Users\\prajwal mj\\Desktop\\mask_rcnn\\Mask_RCNN-master\\samples\\unmask\\frame_7_350_0_person.jpg")
    img1 = cv.imread("C:\\Users\\prajwal mj\\.spyder-py3\\Project\\frame_collect\\"+ ip4+ "-objects\\person-2.jpg")
    cv.imwrite("C:\\Users\\prajwal mj\\darkflow\\sample_img\\person-2.jpg", img1)
    img = crop(img1)
    #print(img)
    for fn in glob(img):
        frame = cv.imread(fn)
        ...
        print('BEFORE POST PROCESS: ',frame_count_out)
        # Remove the bounding boxes with low confidence
        flag_1 = postprocess(frame, outs)
        print('AFTER POST PROCESS: ',frame_count_out)
        ...
        '''import os
        os.system("pathchange_2.bat")'''
        print('LAST: ',frame_count_out)
